        ...
        <nav>
            ...
            >
                <div
                    ...
                    id="navbar"
                >
                    <h1 className="self-center text-2xl mb-2 font-bold whitespace-nowrap dark:text-white">
                        Game Night
                    </h1>
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            ...
                            >
                                <li>
                                    <Link
                                        to="/games"
                                        className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-5 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                                    >
                                        <svg
                        ...
                        <li>
                            <button
                                type="button"
                                className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                                aria-controls="dropdown-all-events"
                                data-collapse-toggle="dropdown-all-events"
                            >
                                <svg
                                    className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                    aria-hidden="true"
